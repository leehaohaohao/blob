            ...
            if (data.success) {
                ...
                announcements.forEach((announcement, index) => {
                    ...
                    block.onclick = function () {
                        // 显示对应的公告内容
                        document.getElementById('announcementContent').textContent = announcement.noteContent;
                ...
                if (announcements.length > 0) {
                    document.getElementById('announcementContent').textContent = announcements[0].noteContent;
                    // 默认选中第一个小方块
