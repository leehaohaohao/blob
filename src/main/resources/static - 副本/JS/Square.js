...
function showAllPost(allPost){
    ...
    posts.forEach((item,index)=>{
        ...
        }).join("")+"</tag><div class='userBelowImg'><a class='titleBelow_a'href=individualSpace.html?userId='"+item.otherInfoDto.userInfoDto.userId+
...
function Status(stmt){
    switch(stmt.status){
     case(0):return"<div class='link followlink' onclick='linkToOne(this,\""+stmt.userInfoDto.userId+"\")'>+</div>"
;
