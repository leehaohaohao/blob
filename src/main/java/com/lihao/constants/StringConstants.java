...
public class StringConstants {
    ...
    public final static String DEFAULT_USER_AVATAR = "http://localhost:9090/blob/img/defAva.png";
    public final static String DEFAULT_POST_COVER = "http://localhost:9090/blob/img/background.png";
