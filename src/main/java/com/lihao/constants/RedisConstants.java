...
public class RedisConstants {
    public final static String REDIS_TOKEN_USER_ID = "blob:token:user:id:";
    public final static String REDIS_TOKEN_USER_INFO = "blob:token:user:info:";
    ...
    public final static String REDIS_API = "blob:api:";
}
